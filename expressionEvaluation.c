...
/*The function converts infix expression into postfix expression. 
  Firstly, check if the infix expression is legal, if it's illegal, print error information and return 0.
...
int infixToPostfix(char* infixExpression, char postfixExpression[]){   
	...
	while(infixExpression[index] != '\0'){
		/*
		  ...
		  then print proper error information and return 0 to indicate illegal characters in expression.  
		*/
